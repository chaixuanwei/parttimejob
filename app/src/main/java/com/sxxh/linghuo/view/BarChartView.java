...
public class BarChartView extends View {
    ...
    public BarChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        colors = new int[]{ContextCompat.getColor(context, R.color.app_theme_color), ContextCompat.getColor(context, R.color.app_theme_color), ContextCompat.getColor(context, R.color.app_theme_color), ContextCompat.getColor(context, R.color.app_theme_color), ContextCompat.getColor(context, R.color.app_theme_color)};
        init(context, false);
    }
    ...
    private void init(Context context, boolean isUpdate) {
        ...
        mPaintLline.setColor(ContextCompat.getColor(context, R.color.black_theme));
        ...
        mPaintText.setColor(ContextCompat.getColor(context, R.color.black_theme));
