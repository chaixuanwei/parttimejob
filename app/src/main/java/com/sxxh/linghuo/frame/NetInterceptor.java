...
import com.sxxh.linghuo.local_utils.NetHeaders;
...
import static com.sxxh.linghuo.local_utils.NetworkUtils.isNetworkConnected;
...
public class NetInterceptor {
    ...
    public OkHttpClient getClientWithoutCache(){
        return new OkHttpClient.Builder()
                .cache(new Cache(new File(ApplicationJob.getAppContext().getCacheDir(), "NetCache07"),10*1024*1024))
                .connectTimeout(20, TimeUnit.SECONDS)
                .readTimeout(20, TimeUnit.SECONDS)
                .writeTimeout(20, TimeUnit.SECONDS)
                .addInterceptor(getLogInterceptor())
                .addInterceptor(new CommonHeadersInterceptor())
//                .addInterceptor(cacheInterceptor(Application.getAppContext()))
//                .addNetworkInterceptor(cacheInterceptor(Application.getAppContext()))
